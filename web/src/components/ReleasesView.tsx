...
// the GitHub Releases API for malcolmston/migrate.
const RELEASE_LIBS: RelLib[] = [
  { name: MIGRATE.name, icon: MIGRATE.icon, accent: MIGRATE.accent, repo: ghrepo(MIGRATE), url: MIGRATE.repo },
];
